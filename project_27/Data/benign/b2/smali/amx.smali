...
# static fields
.field private static final a:Lamx;
...
.method private a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-direct {v3, v0}, Laie;-><init>([B)V

    if-eqz p2, :cond_1

    invoke-static {}, Lafc;->a()Ljava/util/Set;
    ...
    :cond_1
    invoke-static {}, Lafc;->b()Ljava/util/Set;
...
# virtual methods
.method varargs a(Landroid/content/pm/PackageInfo;[Lafd;)Lafd;
    .locals 6
    ...
    invoke-virtual {v4, v3}, Lafd;->equals(Ljava/lang/Object;)Z
...
.method public a(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
    ...
    :cond_1
    invoke-static {p1}, Lzo;->b(Landroid/content/pm/PackageManager;)Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-direct {p0, p2, v2}, Lamx;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    :cond_2
    invoke-direct {p0, p2, v0}, Lamx;->a(Landroid/content/pm/PackageInfo;Z)Z
...
.method public a(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, v0}, Lamx;->a(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
