...
.method public synthetic constructor <init>(Landroid/os/Parcel;Lby;)V
    .locals 0
...
.method public synthetic constructor <init>(Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/graphics/Bitmap;Landroid/net/Uri;Landroid/os/Bundle;Lby;)V
    .locals 0
...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    .line 220
    invoke-static {p0}, Lca;->a(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lbz;->a(Ljava/lang/String;)Lbz;

    .line 221
    invoke-static {p0}, Lca;->b(Ljava/lang/Object;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lbz;->a(Ljava/lang/CharSequence;)Lbz;

    .line 222
    invoke-static {p0}, Lca;->c(Ljava/lang/Object;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lbz;->b(Ljava/lang/CharSequence;)Lbz;

    .line 223
    invoke-static {p0}, Lca;->d(Ljava/lang/Object;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lbz;->c(Ljava/lang/CharSequence;)Lbz;

    .line 224
    invoke-static {p0}, Lca;->e(Ljava/lang/Object;)Landroid/graphics/Bitmap;

    move-result-object v1

    invoke-virtual {v0, v1}, Lbz;->a(Landroid/graphics/Bitmap;)Lbz;

    .line 225
    invoke-static {p0}, Lca;->f(Ljava/lang/Object;)Landroid/net/Uri;

    move-result-object v1

    invoke-virtual {v0, v1}, Lbz;->a(Landroid/net/Uri;)Lbz;

    .line 226
    invoke-static {p0}, Lca;->g(Ljava/lang/Object;)Landroid/os/Bundle;

    move-result-object v1

    invoke-virtual {v0, v1}, Lbz;->a(Landroid/os/Bundle;)Lbz;

    .line 227
    invoke-virtual {v0}, Lbz;->a()Landroid/support/v4/media/MediaDescriptionCompat;
...
.method public a()Ljava/lang/Object;
    ...
    .line 189
    :cond_1
    invoke-static {}, Lcb;->a()Ljava/lang/Object;
    ...
    invoke-static {v0, v1}, Lcb;->a(Ljava/lang/Object;Ljava/lang/String;)V

    .line 191
    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->b:Ljava/lang/CharSequence;

    invoke-static {v0, v1}, Lcb;->a(Ljava/lang/Object;Ljava/lang/CharSequence;)V

    .line 192
    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->c:Ljava/lang/CharSequence;

    invoke-static {v0, v1}, Lcb;->b(Ljava/lang/Object;Ljava/lang/CharSequence;)V

    .line 193
    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->d:Ljava/lang/CharSequence;

    invoke-static {v0, v1}, Lcb;->c(Ljava/lang/Object;Ljava/lang/CharSequence;)V

    .line 194
    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->e:Landroid/graphics/Bitmap;

    invoke-static {v0, v1}, Lcb;->a(Ljava/lang/Object;Landroid/graphics/Bitmap;)V

    .line 195
    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->f:Landroid/net/Uri;

    invoke-static {v0, v1}, Lcb;->a(Ljava/lang/Object;Landroid/net/Uri;)V

    .line 196
    iget-object v1, p0, Landroid/support/v4/media/MediaDescriptionCompat;->g:Landroid/os/Bundle;

    invoke-static {v0, v1}, Lcb;->a(Ljava/lang/Object;Landroid/os/Bundle;)V

    .line 197
    invoke-static {v0}, Lcb;->a(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {v0, p1, p2}, Lca;->a(Ljava/lang/Object;Landroid/os/Parcel;I)V
