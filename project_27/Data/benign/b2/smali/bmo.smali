...
.method public constructor <init>(Lbku;)V
    ...
    iput-wide v0, p0, Lbmo;->e:J

    .line 67
    const-wide v0, 0x3fc2492492492492L    # 0.14285714285714285

    iput-wide v0, p0, Lbmo;->f:D

    .line 49
    invoke-virtual {p1}, Lbku;->c()Landroid/content/Context;
    ...
    iput-object v0, p0, Lbmo;->b:Landroid/util/DisplayMetrics;
    ...
    iget-object v2, p0, Lbmo;->b:Landroid/util/DisplayMetrics;
    ...
    iget-object v3, p0, Lbmo;->b:Landroid/util/DisplayMetrics;
    ...
    iput-object v2, p0, Lbmo;->a:Landroid/content/res/Resources;

    .line 56
    new-instance v0, Lbmp;

    invoke-static {v1}, Lbmo;->a(Landroid/content/Context;)I

    move-result v1

    div-int/lit8 v1, v1, 0x7

    invoke-direct {v0, v1}, Lbmp;-><init>(I)V

    iput-object v0, p0, Lbmo;->c:Lbmp;
...
.method public static a(Landroid/content/res/Resources;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v4, v3}, Lbmn;->a([BII)I
    :try_end_0
    ...
    invoke-static {v3}, Lbka;->a([Ljava/io/Closeable;)V
    ...
    .line 222
    invoke-static {v0, v1}, Lbmo;->a(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method public static a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v1, p0}, Lbmq;-><init>(Ljava/io/InputStream;)V

    .line 230
    invoke-virtual {v1, v3}, Lbmq;->mark(I)V
    ...
    .line 233
    invoke-virtual {v1, v2}, Lbmq;->read([B)I
    ...
    invoke-static {v2, v4, v3}, Lbmn;->a([BII)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 239
    :goto_0
    invoke-virtual {v1}, Lbmq;->reset()V
    ...
    .line 242
    invoke-static {v1, v0}, Lbmo;->a(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method public static a([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 194
    :cond_1
    invoke-static {p0, p1, p2}, Lbmn;->a([BII)I
...
.method private a(Landroid/graphics/BitmapFactory$Options;II)Landroid/graphics/BitmapFactory$Options;
    ...
    .line 139
    :cond_1
    invoke-direct {p0, p2, p3}, Lbmo;->a(II)Landroid/graphics/Point;
...
.method private a(II)Landroid/graphics/Point;
    ...
    .line 126
    iget-object v1, p0, Lbmo;->b:Landroid/util/DisplayMetrics;
...
.method public a(Landroid/content/res/Resources;III)Landroid/graphics/BitmapFactory$Options;
    ...
    .line 167
    invoke-direct {p0, v0, p3, p4}, Lbmo;->a(Landroid/graphics/BitmapFactory$Options;II)Landroid/graphics/BitmapFactory$Options;
...
.method public a(Ljava/io/File;II)Landroid/graphics/BitmapFactory$Options;
    ...
    .line 153
    invoke-direct {p0, v0, p2, p3}, Lbmo;->a(Landroid/graphics/BitmapFactory$Options;II)Landroid/graphics/BitmapFactory$Options;
...
.method public a([BIIII)Landroid/graphics/BitmapFactory$Options;
    ...
    .line 160
    invoke-direct {p0, v0, p4, p5}, Lbmo;->a(Landroid/graphics/BitmapFactory$Options;II)Landroid/graphics/BitmapFactory$Options;
...
.method public a(Lbmm;)V
    ...
    .line 78
    :cond_0
    iget-object v0, p0, Lbmo;->d:Lbku;

    invoke-virtual {v0}, Lbku;->c()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0}, Lbmo;->a(Landroid/content/Context;)I

    move-result v0

    int-to-double v0, v0

    iget-wide v2, p0, Lbmo;->f:D
    ...
    invoke-virtual {v1, v2, v3}, Lbmp;->a(J)V

    .line 81
    :cond_1
    iget-object v0, p0, Lbmo;->c:Lbmp;

    iget-object v1, p1, Lbmm;->c:Ljava/lang/String;

    invoke-virtual {v0, v1, p1}, Lbmp;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 82
    return-void
.end method

.method public b(Lbmm;)V
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Lbmp;->a(Ljava/lang/String;Lbmm;)V
