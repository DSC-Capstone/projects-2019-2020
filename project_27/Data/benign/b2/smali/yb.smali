...
# direct methods
.method constructor <init>(Lya;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1, v2}, Lyb;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v3, p2, v0}, Lya;->c(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method private b(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1, v1}, Lyb;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
...
.method public getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0}, Lya;->a(Lya;)Lxd;
    ...
    invoke-virtual {v0, v1}, Lya;->f(Ljava/lang/String;)V

    iget-object v0, p0, Lyb;->a:Lya;

    invoke-static {v0}, Lya;->b(Lya;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lyb;->a:Lya;

    invoke-virtual {v1}, Lya;->o()Landroid/content/Context;
    ...
    invoke-static {v1}, Lya;->a(Lya;)Lxd;

    move-result-object v1

    invoke-virtual {v1}, Lxd;->b()V
    :try_end_1
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-virtual {v1, v2, v0}, Lya;->e(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {v0}, Lyy;->a(Ljava/lang/String;)Z
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct {p0, p1, v0}, Lyb;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {}, Lya;->j()Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, p1}, Lyb;->a(Landroid/database/sqlite/SQLiteDatabase;)V

    goto :goto_0

    :cond_2
    invoke-direct {p0, p1}, Lyb;->b(Landroid/database/sqlite/SQLiteDatabase;)V
