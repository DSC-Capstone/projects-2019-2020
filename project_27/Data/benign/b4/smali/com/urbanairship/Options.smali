...
.method public loadFromProperties(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v1, "Options - Couldn\'t find "
    ...
    const-class v1, Lcom/urbanairship/Options;
    ...
    check-cast v1, Lcom/urbanairship/PropertyName;

    if-eqz v1, :cond_9

    invoke-interface {v1}, Lcom/urbanairship/PropertyName;->name()Ljava/lang/String;
    ...
    const-string v6, "Found PropertyAnnotation for "
    ...
    const-string v1, "\' because the field is not visible."
    ...
    :cond_5
    invoke-virtual {p0, v0, v1}, Lcom/urbanairship/Options;->parseOptionValues(Ljava/lang/reflect/Field;Ljava/lang/String;)I
    ...
    const-string v1, "\' due to unknown configuration value."
    ...
    const-string v2, "\' due to type mismatch."
...
.method parseOptionValues(Ljava/lang/reflect/Field;Ljava/lang/String;)I
    ...
    const-string v2, "\' due to unknown configuration value."
    ...
    const-string v2, "\' because the object is not compatible with the declaring class."
    ...
    const-string v2, "\' because this field is not accessible."
    ...
    const-string v2, "\' due to type mismatch or missing annotation."
